...
SignaturePad.prototype.fromDataURL = function(dataUrl) {
  ...
  image.onload = function() {
    ...
    _this._ctx.canvas.width =
      image.width * ratio > window.screen.width || window.screen.width > 767
        ? image.width * ratio > width
          ? width
          : image.width * ratio
        : window.screen.width - image.width * ratio > 200
        ? image.width * ratio
        : window.screen.width;
    _this._ctx.canvas.height = image.height * ratio;
    _this._ctx.clearRect(0, 0, width, height);
    _this._ctx.drawImage(
      image,
      0,
      0,
      image.width,
